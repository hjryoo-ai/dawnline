...
| 항목 | 내용 |
|---|---|
| 상태 | Accepted (**후속 정정 있음** — 아래 「[후속 정정 — 2026-09-26] 계획 하나는 트랜잭션 하나다」. 그 트랜잭션의 범위는 [ADR-064](ADR-064-planning-computes-outside-the-transaction.md) 가 **쓰기**로 좁혔다 — 계산은 트랜잭션 밖이다) |
| 결정일 | 2026-09-05 |
