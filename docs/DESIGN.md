...
**`delivery.route-departed` 를 정한다** (2026-09-23, Phase 6-0b — 5-1b 이월 판정,
[ADR-048](adr/ADR-048-replan-reads-its-own-db.md) 재검토 지점 1 을 닫는다).
