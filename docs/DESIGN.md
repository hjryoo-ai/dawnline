...
- **근무조는 둘이다** (2026-09-08, [ADR-030](adr/ADR-030-night-shift-seed.md)): 캠프당 **야간 8대(23:00–08:00)** · **주간 12대(09:00–22:00)**. 냉장·대형을 두 조에 걸쳐 나눈다 — 야간 냉장 5·트럭 3, 주간 냉장 3·트럭 3, 위험물은 조마다 1대. 야간의 냉장 비중이 높은 것은 §6.3 의 전제 그대로다(DAWN 은 신선식품 비중이 높다). **이전에는 200대 전부 06:00–22:00 이었다** — 「당일·새벽 배송」을 표방하면서 DAWN 티어의 약속 시간대(§2.2 익일 00:00–07:00)에 일하는 차량이 하나도 없었다. 이 부록의 누락이었다.
