...
> **벤치마크 결과 — Phase 3에서 최초 측정, Phase 4에서 확정.**
> 전략별 총비용·총거리·계획 시간·미배정률 비교표가 `docs/benchmarks/` 에 커밋되면 여기에 링크한다.
> 목표치(`baseline-nn` 대비 총비용 ≥ 15% 절감, 5,000 주문 계획 p95 ≤ 30초)는 **아직 측정되지 않은 목표**이며,
