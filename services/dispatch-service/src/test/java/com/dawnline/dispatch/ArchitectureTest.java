...
class ArchitectureTest {
    ...
    static void 헥사고날_규칙을_모두_지킨다(JavaClasses classes) {
        ...
        assertThat(rules).as("DESIGN.md §13 의 서비스 대상 ArchUnit 규칙 11개 (규칙 10 은 libs/common 에 건다, 규칙 12 는 코어에)").hasSize(11);
