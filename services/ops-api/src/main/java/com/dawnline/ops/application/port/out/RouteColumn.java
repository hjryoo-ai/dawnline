...
/**
 * {@code rm_routes} 에서 핸들러가 쓰는 칸. {@code completed_count}·{@code failed_count}·{@code live_count}·
 * {@code completed_at} 은 없다 — 집계라서 {@link RouteRows#recount} 가 쓴다(ADR-051 결정 4 · ADR-061).
 */
